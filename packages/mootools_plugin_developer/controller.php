...
class MootoolsPluginDeveloperPackage extends Package {

	const PACKAGE_HANDLE = 'mootools_plugin_developer';

	protected $pkgHandle = MootoolsPluginDeveloperPackage::PACKAGE_HANDLE;
	protected $appVersionRequired = '5.4.0';
	protected $pkgVersion = '1.0';

	public function getPackageName() {
		return t('Mootools Plugin Developer');
	}
	
	public function getPackageDescription() { 
		return t('Add-on package for Mootools plugin developer');
	}

	public function install() {

		Loader::library('mootools/attribute', MootoolsPluginDeveloperPackage::PACKAGE_HANDLE);
