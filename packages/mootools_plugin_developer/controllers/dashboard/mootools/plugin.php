...
Loader::library('mootools/plugin_list', MootoolsPluginDeveloperPackage::PACKAGE_HANDLE);

class DashboardMootoolsPluginController extends Controller {

	public function view() {
		$handle = MootoolsPluginDeveloperPackage::PACKAGE_HANDLE;
	...
	public function package() {
		...
		$pkgHandle = MootoolsPluginDeveloperPackage::PACKAGE_HANDLE;
		$uID = $u->getUserID();
